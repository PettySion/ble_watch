...
public class SpoReportActivity extends BaseActivity {
    ...
    private void initPage() {
        ...
        // 创建一个集合,装填Fragment
        SpoDayFragment dayFragment =  new SpoDayFragment();
        SpoWeekFragment weekFragment =  new SpoWeekFragment();
        SpoMonthFragment monthFragment =  new SpoMonthFragment();
        // 装填
