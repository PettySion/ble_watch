...
public class SportResultPresenterImpl implements ISportResultPresenter{
    ...
    public void initSportData(SportData sportData) {
        ...
        if (sportData.distance!=0){
            if (unit==0){
                distance = String.format("<font color='#000000',style='bold'><big><big><big>%.2f</big></big></big></font> km",
                        (sportData.distance+5)/10/100f);
            }else {
                distance = String.format("<font color='#000000',style='bold'><big><big><big>%.2f</big></big></big></font> mile",
                        MathUtil.newInstance().km2Miles(sportData.distance/10));
            }
        }else {
            distance =  String.format("<font color='#000000',style='bold'><big><big><big>%s</big></big></big></font> km",
